      ...
      <Sidebar collapsible="icon">
        <SidebarHeader className="flex flex-col gap-4 pt-4">
          <div className="flex items-center gap-2 pl-1 group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:pl-0">
            <div
              className={cn(
                "flex items-center justify-center h-9 w-9 overflow-hidden transition-all duration-300 ease-in-out", // Fixed height (h-9 = 36px) to match SidebarTrigger
                sidebar.state === "collapsed" &&
                  "group hover:bg-sidebar-accent rounded-md",
              )}
            >
              {sidebar.state === "collapsed" ? (
                <>
                  ...
                  <Image
                    ...
                    height={24}
                    className={cn(
                      "rounded-sm transition-all duration-300 ease-in-out shrink-0",
                      "group-hover:w-0 group-hover:opacity-0 group-hover:scale-75",
                    )}
                  />
                </>
              ) : (
